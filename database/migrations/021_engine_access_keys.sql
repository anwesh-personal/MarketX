...
CREATE INDEX IF NOT EXISTS idx_engine_access_keys_engine_id ON engine_access_keys(engine_id);
CREATE INDEX IF NOT EXISTS idx_engine_access_keys_key_hash ON engine_access_keys(key_hash);
