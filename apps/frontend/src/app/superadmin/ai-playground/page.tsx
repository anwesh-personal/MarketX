        ...
        <div className="group relative">
            ...
            <div className="absolute left-0 top-6 w-80 bg-background border border-border rounded-lg p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-2 p-2 bg-warning-muted border border-borderHover rounded">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="bg-success-muted border border-borderHover rounded-lg px-4 py-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-surface border border-border rounded-xl p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-2">
                                    <div className="bg-info-muted border border-borderHover rounded p-2 text-center">
                                        <div className="text-xs text-info">Words</div>
                                        <div className="text-sm font-bold text-textPrimary">{tokenContext.words}</div>
                                    </div>
                                    <div className="bg-success-muted border border-borderHover rounded p-2 text-center">
                        ...
                        {/* Cost Estimate */}
                        <div className="mt-4 p-3 bg-warning-muted border border-borderHover rounded">
